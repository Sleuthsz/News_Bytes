...
class NBC:
    ...
    def get_world_news_headlines(self):
        ...
        world_news_link = self.driver.find_elements(By.CLASS_NAME, "related-content__headline")
    ...
    def get_sports_headlines(self):
        self.driver.get('https://www.nbcsports.com/?cid=eref:nbcnews:text')
        sports_link = self.driver.find_elements(By.CLASS_NAME, "more-headlines__list-item")
...
if __name__ == "__main__":
    ...
    # print(headlines)
    # article = nbc.get_article_text(headlines[1][1])
    # print(article)
